...
<img src="/assets/images/scrum-agile/scrum_process.jpg" alt="Scrum Framework Workflow Process">
...
2. **Inspection** - Scrum framework encourages constant inspection of tasks and the progress towards the Product Goals. The presence of inspection leads to reduced risk and allows for quick adaptations in instances where a pivot is needed.
...
1. **Kanban** - The best framework for continuous workflows like support or services. Kanban allows for tasks of different sizes and importance to be simultaneously guided through the workflow, leaving a lot of room for flexible prioritization.
